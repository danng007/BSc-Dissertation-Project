...
void Triangle::Draw()
{
// remeber the current state of the GL_MODELVIEW matrix before we add the traingle transforms too it
    glPushMatrix();

		// Move the triangle back into the scene (as the camera starts at (0,0,0))
...
void Triangle::HandleKey(int key, int state, int x, int y )
{
